...
//	/*显示静态字符串*/
//	OLED_ShowString(1, 1, "Num:");			//2行1列显示字符串Num:      Num控制在（-100-100）因为速度有上限低于或者高于极限都不在变动
	OLED_ShowString(1, 1, "YIXINTDS1:");
	OLED_ShowString(2, 1, "TEM1:");
	OLED_ShowString(3, 1, "YIXINTDS2:");
	OLED_ShowString(4, 1, "TEM2:");
...
//		OLED_ShowHexNum(4, 7,Serial_RxPacket[10], 2);
		...
		S2data = YIXIN2_ParseData();
		OLED_ShowNum(1, 11, Sdata.tds, 4);
		OLED_ShowNum(2 , 6, Sdata.temp, 3);
		OLED_ShowNum(3, 11, S2data.tds, 4);
		OLED_ShowNum(4, 6, S2data.temp, 3);
